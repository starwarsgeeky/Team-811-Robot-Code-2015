...
public class Robot extends IterativeRobot implements Config {
    ...
    public void robotInit() {
        ...
        autoChooser.addDefault("Just drive", new JustDriveAuto());
        ...
        autoChooser.addObject("Three Totes v2- zig zag", new ThreeToteAutov2());
        autoChooser.addObject("Three Totes v4- pick up container then zig zag", new ThreeToteAutov4());
